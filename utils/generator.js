...
var nickname = [
  "喵小懒", "思钱想厚", "稚于最初", "℡宿命。", "天生傲骨、怎能服输",
  "守一座空城ヾ", "許我壹筆墨, 绘妳倾城顏", "冷暖自知", "时光凉",
  "向来缘浅", "北鼻", "令狐冲笑熬浆糊", "骑蜗牛撵大象", "埖埖迣鎅、芣怭當嫃",
  "ㄣ潇潇ㄣ", "给祢的承诺、卟会过期", "24K纯爷们", "我心飞扬", "蝶ル飛",
  "丢了的自己，要记得捡回来", "别回头我从来不等狗", "低調の華麗", "暖了夏天蓝了海°",
  "Royal╰大懒猫″", "女人ヽ无须楚楚可怜", "寂寞如雪", "放开我，我要装逼", "喵小咪℡",
  "随遇而安", "如人饮水冷暖自知", "Forever、卟离", "﹎黯淡",
  "梦里梦见梦", "别留我孤身一人", "越王够贱", "人心太狗", "正在输入ヽ请稍后", "緈鍢dē掉渣",
  "半醉半醒半痴呆", "总有刁民想害朕", "擦掉眼泪我依旧是王", "北巷°", "风继续吹", "精神分裂患者",
  "凉辰梦瑾°", "愿用余生去念你", "", "谁动朕江山，朕掘他祖坟", "首席男妓", "吃了范冰冰就会杜拉拉",
  "嘸懙倫仳", "ロ觜角よ揚℅", "浅唱、淡夏", "婼即婼離", "花样作死冠军", "站在北纬30°想你", "承蒙时光不弃",
  "活出别致的高傲", "帅dē掉渣", "孤身撑起①片天", "烈酒封喉", "屋檐滑落的雨滴﹌", "乱了夏末蓝了海",
  "心不动丶则不痛", "褪色的旧时光", "獨愛伱一個ヤ", "以女皇的霸气统领整个世界", "安於現狀。",
  "时间会咬人", "别看了你帅不过我的", "姐很拽ㄨ不要爱", "香蕉不娇", "纵有南风起",
  "萌界一把手", "孟婆，来杯咖啡", "烟花散尽、不问繁华", "冷暖自知", "谁给我的QQ喂了止咳糖浆", "嘴角残留余温",
  "酒醉人散", "浮华如梦°", "一身温柔病", "只如初见", "醉人心", "闲言碎语ら", "别来无恙", "微微一笑抽了筋",
  "假装无所谓", "落花忆梦", "陪俄、看ㄖ出", "雨落倾城夜微凉", "生来不讨喜", "情场废物", "遇见她ぴ许了她",
  "黄泥鳅与大白鲨", "吃货家族miss", "ζ小执着°", "我是你家宝贝", "混世小野女", "萌宝", "小仙女",
  "我是孜然味哒！", "萌翻全场", "萌妹子", "萍酷宝", "听，奶哭的声音", "软妹",
  "追着幸福跑", "小怪兽", "请止步、禁区", "一身祖宗味", "拉粑粑的小魔仙", "可爱到炸",
  "壊壊♀儍尐孒", "长的很欠揍", "油炸小逗比", "仇家太多了不方便透漏名字", "全村的希望", "五行缺爱",
  "疯到世界奔溃", "啷个哩个啷", "姐就这么拽，不服就憋着", "爬进棺材调戏鬼", "求岳母发货", "迷倒万千少女",
  "矮油喂", "小不正经ε", "情场痞子", "犇羴骉", "痞男", "蹲街ぃ看帅哥", "骑猪闯天下", "可耐的智障",
  "姐ゝ夲灞芞", "⌒喵⌒", "待我长发及腰就勒死你", "小笨豬の幸福", "飞奔的五花肉", "姐√拽得有个性",
  "丑到惊动联合国", "狂奔的蚂蚁", "⊕3⊕", "被淹死的鱼", "爱笑的智障", "国民小逗比"];
